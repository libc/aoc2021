...
impl Game {
    fn start() -> Self {
        ...
        let grid = vec![
            ...
            ((6, 4), Amphipod::Amber(1)),
            ((4, 1), Amphipod::Bronze(0)),
            ((2, 4), Amphipod::Bronze(1)),
            ((8, 1), Amphipod::Copper(0)),
            ((8, 4), Amphipod::Copper(1)),
            ((2, 1), Amphipod::Desert(0)),
            ((4, 4), Amphipod::Desert(1)),
            ((2, 2), Amphipod::Desert(2)),
            ((2, 3), Amphipod::Desert(3)),
            ((4, 2), Amphipod::Copper(2)),
            ((4, 3), Amphipod::Bronze(2)),
            ((6, 2), Amphipod::Bronze(3)),
            ((6, 3), Amphipod::Amber(2)),
            ((8, 2), Amphipod::Amber(3)),
            ((8, 3), Amphipod::Copper(3)),
            //
